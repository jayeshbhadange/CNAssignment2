...
if __name__ == '__main__':
    ...
    net['ra'].cmd('ip route add 10.0.0.0/24 via 192.168.2.2')
    net['ra'].cmd('ip route add 172.16.0.0/24 via 172.16.2.2')
    # Add static routes on rb
    net['rb'].cmd('ip route add 192.168.1.0/24 via 192.168.2.1')
    net['rb'].cmd('ip route add 172.16.0.0/24 via 10.0.2.2')
    # Add static routes on rc
    net['rc'].cmd('ip route add 192.168.1.0/24 via 172.16.2.1')
    net['rc'].cmd('ip route add 10.0.0.0/24 via 10.0.2.1')
